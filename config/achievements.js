...
export const ACH = [
  ...
  { id:'egg',     g:'all', tier:'secret', name:'Excuses',     how:'Found the full stop', unlocks:['sq','#FF7A59'] },
  ...
  { id:'qt_s5',      g:'quick-tap', tier:'secret', name:'No excuses',           how:'Four · 5 hits a second on a Sprint', at:{d:'four',s:5} },
  { id:'qt_s15',     g:'quick-tap', tier:'secret', name:'Still no excuses',     how:'Four · 5 hits a second, held for a Dash', at:{d:'four',s:15} },
  { id:'qt_s30',     g:'quick-tap', tier:'secret', name:'Not normal',           how:'Four · 5 hits a second, held for a Marathon', at:{d:'four',s:30} },
  { id:'qt_bs5',     g:'quick-tap', tier:'secret', name:'Two faith',            how:'Two · 5 hits a second on a Sprint', at:{d:'two',s:5} },
  // dots
  ...
  { id:'dt_s',     g:'dots', tier:'secret', name:'Radar',            how:'Lead · 4.5 a second held for a Marathon', at:{d:'lead',s:30} },
  { id:'dt_bs',    g:'dots', tier:'secret', name:'Sonar',            how:'Blind · 3.5 a second held for a Marathon', at:{d:'blind',s:30} },
  ...
  { id:'sq_s20',  g:'sequence', tier:'secret', name:'Twenty',       how:'Round 20 on any keys' },
  { id:'sq_s15',  g:'sequence', tier:'secret', name:'The long one', how:'Round 15 on seven keys', at:{s:7} },
