...
export const ACH = [
  ...
  { id:'qt_clean5',  g:'quick-tap', tier:'unlock', name:'Clean · Sprint · Four', how:'Four · Sprint, no misses, at least 7 hits', unlocks:['sq','#9BE8FF'], at:{d:'four',s:5}, live:1 },
  { id:'qt_bclean5', g:'quick-tap', tier:'unlock', name:'Clean · Sprint · Two',  how:'Two · Sprint, no misses, at least 8 hits', at:{d:'two',s:5}, live:1 },
  { id:'qt_r4',      g:'quick-tap', tier:'unlock', name:'Quick',                how:'Four · 3 hits a second, any length', unlocks:['snd','click'], at:{d:'four'}, live:1 },
  { id:'qt_clean15', g:'quick-tap', tier:'unlock', name:'Clean · Dash',         how:'Four · Dash, no misses, at least 24 hits', unlocks:['bg','rain'], at:{d:'four',s:15}, live:1 },
  { id:'qt_clean30', g:'quick-tap', tier:'pro',    name:'Clean · Marathon',     how:'Four · Marathon, no misses, at least 50 hits', unlocks:['sq','#C6FF7A'], at:{d:'four',s:30}, live:1 },
  ...
  { id:'qt_eyes',    g:'quick-tap', tier:'pro',    name:'Eyes shut',            how:'Two · clean Marathon, at least 60 hits', unlocks:['lead','#FF4FD8'], at:{d:'two',s:30}, live:1 },
  { id:'qt_sab',     g:'quick-tap', tier:'pro',    name:'Committed',            how:'Two · a run of nothing but misses, at least five', at:{d:'two'}, live:1 },
  ...
  // dots
  { id:'dt_pin',   g:'dots', tier:'unlock', name:'Pinpoint',         how:'Lead · a clean Sprint with at least 8 hits', unlocks:['sq','#FFD1DC'], at:{d:'lead',s:5}, live:1 },
  { id:'dt_bpin',  g:'dots', tier:'unlock', name:'Pinpoint · Blind', how:'Blind · a clean Sprint with at least 6 hits', at:{d:'blind',s:5}, live:1 },
  { id:'dt_sweep', g:'dots', tier:'unlock', name:'Sweep',            how:'Lead · 3 hits a second over a Dash', unlocks:['lead','#7CFFB2'], at:{d:'lead',s:15}, live:1 },
  { id:'dt_land',  g:'dots', tier:'pro',    name:'Landing',          how:'Lead · a clean Marathon with at least 45 hits', unlocks:['bg','orbs'], at:{d:'lead',s:30}, live:1 },
  ...
  { id:'hd_money',  g:'hold', tier:'unlock', name:'On the money', how:'One round within 2.00%', unlocks:['snd','wood'], live:1 },
  ...
  // sequence
  { id:'sq_7',    g:'sequence', tier:'unlock', name:'Seven',        how:'Reach round 7 on any keys', unlocks:['bg','stars'], live:1 },
  ...
  { id:'sq_5x10', g:'sequence', tier:'pro',    name:'Ten on five',  how:'Round 10 on five keys', at:{s:5}, live:1 },
  ...
  { id:'tm_close', g:'timing',   tier:'unlock', name:'Dead on',       how:'Stopwatch · one attempt within 0.10s', at:{d:'stopwatch'}, live:1 },
  ...
  { id:'rx_200',   g:'reaction', tier:'unlock', name:'Under 200',     how:'Flash · one tap under 200ms', at:{d:'flash'}, live:1 },
  ...
  { id:'sp_5',     g:'spot',     tier:'unlock', name:'Eight',         how:'Count · reach round 8 in a Streak', at:{d:'count',s:-1}, live:1 },
