...
export const KEY_BARS = {
  'quick-tap:two:5':      { id:'qt-two-5', bar:12, dir:'higher', unit:'hits', conf:'med', basis:'Marathon opens at 20 hits in a Dash (1.33/s); a player who got there runs nearer 2.4/s.' },
  'quick-tap:two:15':     { id:'qt-two-15', bar:34, dir:'higher', unit:'hits', conf:'med', basis:'2.3/s — past the 20-hit gate that opens Marathon, short of a clean run.' },
  'quick-tap:two:30':     { id:'qt-two-30', bar:64, dir:'higher', unit:'hits', conf:'med', basis:'2.1/s. Same player as the Dash bar, thirty seconds in.' },
  'quick-tap:four:5':     { id:'qt-four-5', bar:9, dir:'higher', unit:'hits', conf:'low', basis:'Four adds a visual search to every tap. Set at ~75% of the Two rate — that ratio is the guess.' },
  'quick-tap:four:15':    { id:'qt-four-15', bar:26, dir:'higher', unit:'hits', conf:'low', basis:'Same 75% ratio against Two · Dash.' },
  'quick-tap:four:30':    { id:'qt-four-30', bar:48, dir:'higher', unit:'hits', conf:'low', basis:'Same 75% ratio against Two · Marathon.' },
  'dots:blind:5':         { id:'dt-blind-5', bar:13, dir:'higher', unit:'hits', conf:'med', basis:'2.6/s. The Sprint gate is 6 hits with no misses, which tests accuracy not speed.' },
  'dots:blind:15':        { id:'dt-blind-15', bar:38, dir:'higher', unit:'hits', conf:'high', basis:'Marathon opens at 35 hits in a Dash (2.33/s). The bar sits just above the gate that lets you reach it.' },
  'dots:blind:30':        { id:'dt-blind-30', bar:72, dir:'higher', unit:'hits', conf:'med', basis:'2.4/s held for thirty seconds.' },
  'dots:lead:5':          { id:'dt-lead-5', bar:15, dir:'higher', unit:'hits', conf:'low', basis:'The outline removes the search, so Lead should beat Blind. The 15% lift is the assumption to test.' },
  'dots:lead:15':         { id:'dt-lead-15', bar:44, dir:'higher', unit:'hits', conf:'low', basis:'Same 15% lift over Blind · Dash.' },
  'dots:lead:30':         { id:'dt-lead-30', bar:84, dir:'higher', unit:'hits', conf:'low', basis:'Same 15% lift over Blind · Marathon.' },
  'hold:grow:7':          { id:'es-grow-set', bar:9, dir:'lower', unit:'% off', conf:'med', basis:'Cut opens on a single Grow round within 15%. An average held over seven rounds should sit well under a one-round gate.' },
  'hold:grow:-1':         { id:'es-grow-streak', bar:12, dir:'higher', unit:'rounds', conf:'med', basis:'The budget is 100% cumulative — at a 9% average round the run lasts about eleven.' },
  ...
  'reaction:nogo:5':      { id:'rx-ng-set', bar:380, dir:'lower', unit:'ms avg', conf:'med', basis:'A go/no-go tap runs ~100ms behind a simple one. The 150ms wrong-tap penalty is inside this average, so it caps mistakes too.' },
  'reaction:nogo:-1':     { id:'rx-ng-streak', bar:5, dir:'higher', unit:'rounds', conf:'med', basis:'1000ms budget spending over 150ms, 200ms a wrong tap. At a 380ms average each rep costs ~230ms.' },
  'spot:count:10':        { id:'sp-ct-set', bar:10, dir:'lower', unit:'miscount', conf:'med', basis:'The ramp opens at five targets and one decoy, adds one of each a round, and the flash falls 70ms a round. By round 10 it is fourteen targets in 570ms.' },
  'spot:count:-1':        { id:'sp-ct-streak', bar:8, dir:'higher', unit:'rounds', conf:'med', basis:'Spot · Find opens at round 5 of Count, so eight is a clear step past.' },
  'spot:find:10':         { id:'sp-fd-set', bar:18, dir:'lower', unit:'s total', conf:'low', basis:'1.8s a find against the 0.5s free window, over a crowd growing from 16 to 70 shapes. No unlock anchors this.' },
  'spot:find:-1':         { id:'sp-fd-streak', bar:8, dir:'higher', unit:'rounds', conf:'low', basis:'Matched to Count · Streak. Find has no threshold of its own.' },
};
