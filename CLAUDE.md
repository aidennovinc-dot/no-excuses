...
**Screens** — one file each under `ui/screens/`: `menu`, `pick`, `board`, `progress` (Game unlocks, Customise and
Achievements tabs), `key`, `about`, `testing`, `pass`, `result`, `lockbox`. A screen calls `register(id, {onShow,
